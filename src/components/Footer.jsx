...
const Footer = () => {
  return (
    <div className='w-full h-auto px-4 flex flex-col md:flex-row bg-white justify-around items-center'>
        <div className='w-[400px] h-[220px] flex flex-col p-5 mt-10'>
        ...
        <div className='w-[400px] h-[200px] flex flex-col justify-center p-5 md:mt-10 md:pb-5'>
        ...
        <div className='w-[400px] h-[200px] flex flex-col justify-center p-5 mt-10'>
